...
<%@page import="java.util.Arrays"%>
                       ...
                       <center>
				        ...
				        <c:forEach items="${requestScope.studentList}" var="students">
							<tr>
<td><a href="applicantDetailsSearchByInterBoard?applicationID=${students.applicationID}&eiinCode=${students.eiinCode}" target="_blank" >${students.applicationID}</a></td>								
