	...
	<s:iterator value="svgList">
        <tr>
                ...
                <td> 
                	...
                	<input type="hidden" name="gpap" id="gpap_<%=rowcount %>"  value='<s:property value="gpa" />' />
                 ...
                 <td> 
                	...
                	<input type="hidden" name="ownGpap" id="ownGpap_<%=rowcount %>"  value='<s:property value="ownGpa" />' />
                 ...
                 <td> 
                	...
                	<input type="hidden" name="spGpap" id="spGpap_<%=rowcount %>"  value='<s:property value="spGpa" />' />
