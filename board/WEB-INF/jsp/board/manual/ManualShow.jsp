					...
					<center>
						<table style="width: 400px; font-size: 14px;padding-bottom: 0px" class="table table-bordered table-striped cf">
							<tr>
								...
								<td>
									<button id="searchSVG" onclick="searchSVG()" style="font-size: 14px; font-weight: bold; padding: 6px 6px; margin-left: 5px;  box-shadow: 0px 0px 9px #888888;" class="btn btn-success buttonCSV">Show SVG</button>
								</td>
							</tr>
						</table>
...
<script type="text/javascript">
    ...
    function searchSVG() {
       ...
       if($("#eiin").val()==""){
        ...
        $("#cname").html(eiinnames[eiins.indexOf($("#eiin").val())]+' ('+$("#eiin").val()+')');
        currentEiin = $("#eiin").val();
        $("#showapplicant").html('');
