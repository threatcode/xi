  ...
  <div class="row">
                  <!--   <div class="col-lg-12"> -->
                        <!-- <div class="box"> -->
                            ...
                            <!-- /.box-header -->
                            <form action="cancelApproveStudentOfMeritByBoard" method="post" id="cancelApproveStudentOfMeritForm" name="cancelApproveStudentOfMeritForm" onsubmit="return validateForm()" >
				        ...
				        <c:forEach items="${requestScope.approvedStudentListOfMerit}" var="approvedStudent" varStatus="loop">
							<tr>
								...
								<%-- <td>${loop.index+1}</td>  --%>
								<td>${approvedStudent.collegeName}</td>
	...
	<td>
	<input type="checkbox" class="boSelect" name="applicationID" value="${approvedStudent.applicationID}#${approvedStudent.meritType}#${approvedStudent.shiftID}#${approvedStudent.versionID}#${approvedStudent.groupId}#${approvedStudent.eiinCode}#${loop.index}#${approvedStudent.assignedQuota}"  onclick="submitApproveForm()">
	</td> 
                                 ...
                                 <div style="width:140px;float: right;right-padding:0cm">
                                 	<input type="hidden" name="formAction" id="formAction" value="" />
                                  	<br>
                                  	<!-- 
                                  	<input type="button" style="width:140px;padding: 1px 12px;" class="btn btn-danger buttonCancel" name="cancel" value="Cancel Admission" onclick="submitApproveForm()" />                                 	
         -->
                                </div>
...
<script type="text/javascript">
   ...
   {   		
		...
		$.ajax({
		 	url: 'cancelApproveStudentOfMeritByBoard',		
		 	type: 'POST',
		 	async: true,
			cache: false,
