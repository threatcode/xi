...
<head>
    ...
    <link rel="stylesheet" href="/resources/template/css/theme.css">

    <link rel="stylesheet" href="/resources/template/css/style.css">
    <link rel="stylesheet" href="/resources/template/css/dripicon.css">
    <link rel="stylesheet" href="/resources/template/css/typicons.css" />
    ...
    <link rel="stylesheet" href="/resources/template/js/tip/tooltipster.css">
    <link rel="stylesheet" type="text/css" href="/resources/template/js/vegas/jquery.vegas.css" />
    
    <!-- Data Tables  -->
    <link href="/college/resources/template/js/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
    
    <link href="/resources/template/js/footable/css/footable.core.css?v=2-0-1" rel="stylesheet" type="text/css" />
    <link href="/resources/template/js/footable/css/footable.standalone.css" rel="stylesheet" type="text/css" />
    <link href="/resources/template/js/footable/css/footable-demos.css" rel="stylesheet" type="text/css" /> 
    
    <!-- pace loader -->
    <script src="/resources/template/js/pace/pace.js"></script>
    
    <link href="/resources/template/js/pace/themes/orange/pace-theme-flash.css" rel="stylesheet" />
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div style="margin-bottom:0;" class="alert text-white ">
                ...
                <strong>Wellcome back!</strong>&nbsp;&nbsp;Dave, your last loggin was 1 day ago. Have a nice day
            </div>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a data-toggle="dropdown" class="dropdown-toggle text-white" href="#">
                        <img alt="" class="admin-pic img-circle" src="http://api.randomuser.me/portraits/thumb/men/23.jpg">Hi, Dave Mattew <b class="caret"></b>
                    </a>
