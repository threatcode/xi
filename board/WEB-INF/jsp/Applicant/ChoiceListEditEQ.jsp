...
<table class="rounded-corner" id="selection_row_table">
        ...
        <s:iterator value="choice" status="indx">
           ...
           <s:if test='payment_status == "Y"'>
        	...
        	<s:else>
	            ...
	            <td align="center">
	            		<select name="choice[<s:property value='#indx.index' />].education_quota" style="width:50px;">
	            		 <option value="N" <s:if test='education_quota == "N"'>selected="selected"</s:if>>No</option>
	            		 <option value="Y" <s:if test='education_quota == "Y"'>selected="selected"</s:if>>Yes</option>
	            		</select>
	            </td>
	            <td align="center">
	                 <s:if test='application_type == "W"'>
	            ...
	            <td align="center">
	                ...
	                <input type='hidden' name="choice[<s:property value='#indx.index' />].choice_id" value="<s:property value='choice_id'/>" />	            
	            </td>      
	...
	<div class="form_sub_buttons" style="width: 100%;padding-left: 300px;">
		<a href="javascript:void(0)" class="button green" onclick="updateEQInfo()" style="width: 115px;height: 30px;font-size: 20px;">Save </a>	
    </div>
