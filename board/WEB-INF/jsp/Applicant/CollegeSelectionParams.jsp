...
<div id="selection_box" style="float: left; vertical-align: top;margin-top: 0px;margin-left: 2px;padding-left: 2px;">  	
	...
	<s:if test="from_where=='release_slip'">
...
<s:if test="from_where=='release_slip'">
		<input type="button" class="addMoreButton"  value="Add College" id="add_choice" onclick="addChoice('R')" style='margin-right:10px;width:142px;height: 50px;font-size: 18px;'/>
</s:if>
<s:else>
		<input type="button" class="addMoreButton"  value="Add College" id="add_choice" onclick="addChoice('A')" style='margin-right:10px;width:142px;height: 50px;font-size: 18px;'/>
</s:else>
	</div>
  </div>	
</s:if>  