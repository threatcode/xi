...
<div class="reportHeader" >
	<center>
		...
		<font style="font-size: 22px;">Applicant's Information Summary (<b>Release Slip</b>)</font>
	</center>
</div>
...
Release Slip Information <b>(with Priority)</b> : 
</p>
...
<table id="table_choice_list" border="1" cellpadding="4" cellspacing="0" style="border-collapse: collapse;border: 1px solid black;" width="750px" />
	...
	<tr>
		<td width="18" align="center">Priority</td>
		<td width="194" align="left">College Name</td>
		<td width="15" align="center">District</td>
		<td width="15" align="center">EIIN</td>
		<td width="30" align="left">Shift</td>
		<td width="30" align="left">Version</td>
	...
	<s:iterator value="choice" status="indx">
	      ...
	      <td align="center"><b><s:property value="priority"/></b></td>
	            ...
	            <td align="left"><s:property value="dist_name"/></td>
	            ...
	            <td align="center">
	            <s:if test='education_quota=="N"'>-</s:if>
	            <s:else>Y</s:else>
	            </td>
...
<input type="button" id="printButton" onclick="window.print();" value="Print Release Slip" style="font-weight: bold;"/>
</center>
