...
<table class="rounded-corner" id="selection_row_table">
	...
	<div class="form_sub_buttons" style="width: 100%;padding-left: 250px">		
		...
		<a href="javascript:void(0)" class="button green" onclick="window.location='choiceList.action'" style="width: 160px;height: 30px;font-size: 21px;">Edit Choice List</a>
    </div>
