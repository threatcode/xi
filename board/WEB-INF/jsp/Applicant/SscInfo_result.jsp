<div class="box_container" style="height: 201px;margin-top: 8px;">
<div class="box_header">
SSC/Equivalent Examination Information
</div>
<div class="box_body" style="min-height: 143px;">
  
  <div id="ssc_input_div" style="padding-top: 50px;padding-left: 10px;">
  	  ...
  	  <table width="100%" border="0" style="border: none;" id="ssc_input_table">
  	  	...
  	  	<tr>
  	  		<td align="center" style="border: none;"><input type="text" id="ssc_roll" style="width: 135px;text-align: center;" /></td>
  	  		<td align="center" style="border: none;">
  	  			<select style="width:120px;" id="ssc_board" style="width: 135px;">
  	  		...
  	  		<td align="center" style="border: none;"><input type="text" id="ssc_reg" style="width: 135px;text-align: center;"/></td>
  	  	</tr>
  	  </table>
...
<div class="box_footer">
 ...
 <input id="vr" type="button" value="Show Result" onclick="fetchChoiceList()" style="width:100px;"/>
</div>
</div>