<div class="box_container" style="margin-top: 12px;">
			...
			<table width="100%" border="0" style="border: none;"
				...
				<tr>
					<td align="center" style="border: none;">
						<input type="text" id="ssc_roll"
							style="width: 135px; text-align: center;" maxlength="15" />
					</td>
					<td align="center" style="border: none;">
						<select style="width: 120px;" id="ssc_board"
							onchange="reloadYear(this.value)" style="width:135px;">
				...
				<tr>
					...
					<td align="center" style="border: none;"></td>
					<td width="25%" align="center"
						style="border: none; padding-right: 9px; text-align: right; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;">
						<FONT COLOR="green" size="4">Verification</FONT>
					</td>
				</tr>
				<tr>
					...
					<td align="center" style="border: none; text-align: right">
						<table border="0">
							<tr>
								<td style="border: 0px">
									<img id="captchaImg" src="captcha" alt="Captcha Image"
										height="30">
								</td>
								<td style="border: 0px">
									<input type="text" id="user_captcha" name="u_cap"
	...
	<div class="box_footer" style="height: 39px;">
		<input type="button" class="myButton blue" id="clearButton"
			value="View Payment Information" onclick="validateRegInfo()" />
	</div>
</div>