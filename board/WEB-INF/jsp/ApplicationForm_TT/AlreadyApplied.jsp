...
<center><font size="4" color="green">Your application has been received successfully.</font></center>
<br><br>
<center>You can select <font size="4" color="red">up to 10 unique colleges.</font><br> </center>
<br>
<center>
	<input type="button" class="myButton" value="Click here to Add choice" onclick="showPersonalInfo()"/>
