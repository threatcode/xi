...
<%-- 		  <div style="float: left;width: 30%;">    
		    <label style="width: 80px;">Birth Date</label>
			<input type="text" name="applicant.ssc_info.birth_date" id="p_birth_date" class="readonly" disabled="disabled" value="<s:property value='applicant.ssc_info.birth_date' />" /> 		
		  </div> --%>
		  <div style="float: left;width: 30%;">
		    <label style="width: 80px;">National ID <font style="color: red;">*</font></label>
		    <input type="text"  onkeydown="return numericOnly(event)"
						class="readonly" maxlength="17" value="<s:property value='applicant.application_info.nid_number' />"
						name="applicant.application_info.nid_number" id="nid_number" />
		  </div>
		  <div style="float: left;width: 30%;">
		    <label style="width: 100px;">Relation</label>
			<select name="applicant.application_info.nidholder" id="nidholder" >
						<s:if test='applicant.application_info.nidholder=="Father"'> 
							<option value="Father" selected>Father</option>
						</s:if>
						<s:if test='applicant.application_info.nidholder!="Father"'> 
							<option value="Father">Father</option>
						</s:if>
						<s:if test='applicant.application_info.nidholder=="Mother"'> 
	  ...
	  <div class="box_row" style="margin: 0px;padding: 0px;width: 95%;text-align: right;">
	  	<font style="font-size: 10px;color: red;">* Optional</font>
	  </div>
	  <div class="box_row merit_row" style="margin-top: 0px;padding-top: 0px">
			...
			<div class="box_row sub_box_container">
				<div
					...
					&#2470;&#2479;&#2492;&#2494; &#2453;&#2480;&#2503; &#2438;&#2474;&#2472;&#2494;&#2480; &#2460;&#2472;&#2509;&#2479; &#2474;&#2509;&#2480;&#2479;&#2507;&#2460;&#2509;&#2479; &#2453;&#2507;&#2463;&#2494; &#2454;&#2497;&#2476; &#2488;&#2494;&#2476;&#2471;&#2494;&#2472;&#2503; &#2472;&#2495;&#2480;&#2509;&#2476;&#2494;&#2458;&#2472; &#2453;&#2480;&#2497;&#2472;&#2404; 
					<br/> 
Please select the quota applicable for you very carefully. 
				</div>
					...
					<table>
						<tr>
							...
							<td style="border: 0px"><input type="checkbox"
								...
								id="FreedomFighterQuotaCheckBox" onclick="showWarnings()"></td>
						</tr>
						<!-- 
						<tr>
...
<div class="box_footer">
	<input type="button" onclick="showPopUp('choiceListReport_TT')" value="Print Previous Application"/>
 		...
 		<input type="button" value="Next" onclick="collegeSelectionUpdateEdit()" style="width:100px;" />
