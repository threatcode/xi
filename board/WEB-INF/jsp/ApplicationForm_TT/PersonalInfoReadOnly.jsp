  ...
  <div id="personal_info_div" style="padding-top: 10px;padding-left: 10px;">
	  <div class="box_row">
		  ...
		  <div style="float: left;width: 33%;">    
			...
			<input type="hidden" name="applicant.application_info.nid_number" id="p_ssc_reg" value="<s:property value='applicant.application_info.nid_number' />" />
		  </div>
	  ...
	  <%-- <div class="box_row">
		  ...
		  <div style="float: left;width: 36%;">
		    <label style="width: 120px;">NID</label>
			<input type="text" name="applicant.application_info.nid_number" id="nid_number"  class="readonly" disabled="disabled" value="<s:property value='applicant.application_info.nid_number' />"  />				    
		  </div>
