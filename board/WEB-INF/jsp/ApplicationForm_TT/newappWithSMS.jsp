...
<center><font size="4" color="green">Your have already applied via SMS.</font></center>
<br><br>

<center>You can update or add choices for <font size="4" color="red">up to 10 unique colleges.</font><br> .</center> 


<br>
<center>
	<input type="button" class="myButton" value="Click here to update" onclick="showPersonalInfoSMS()"/>
