		...
		<div id="right_content">
			...
			<div class="sidebar_section_text">
				<center>
									...
									<table style="width:400px;font-size:12px"
										...
										<tr style="background-color: #f0f8ff;">
											...
											<td><input type="text" id="ssc_roll" name="ssc_roll"
												style="width:150px;" maxlength="15" value="" /></td>
										</tr>
										<tr>
											<td>SSC BOARD:</td>
					...
					<!----body ------>
					<div id="successSvgChangeResultDiv"></div>
					<div id="loader"></div>
				</center>
				<center>
    ...
    function searchApplicant() {
       ...
       if($("#ssc_board").val()=="none"){
        ...
        $.ajax({
            ...
            dataType: 'text',
            async   : false,
            data    : {eiinCode:"--" ,ssc_roll: $("#ssc_roll").val().trim(),ssc_reg: $("#ssc_reg").val().trim(),ssc_board: $("#ssc_board").val().trim(),
