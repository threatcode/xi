...
<div class="center_content">
	<div id="right_wrap">
		<div id="right_content">
			...
			<h2> LIST OF APPROVED STUDENTS </h2>
			<div class="sidebar_section_text">
<center>

<!---- body ----->		
						<center>                    
                        <span>:: LIST OF APPROVED STUDENTS OF 1ST MERIT::</span>                            
                        </center>
                         <br/>
  ...
  <div class="row">
                  <!--   <div class="col-lg-12"> -->
				        ...
				        <c:forEach items="${requestScope.approvedStudentListOfMerit}" var="approvedStudent">
							<tr>
							...
							<%-- 	<td>${approvedStudent.applicationID}</td>
                             ...
                             <%--    <td>
                               <span style="width: 99px;" class="status-metro status-active title="Active">${approvedStudent.admitStatus}</span>
                                </td> --%>
							  ...
							  <td>
								...
								<c:if test="${approvedStudent.meritType=='15'}">
								BTEB 2nd Phase
								</c:if>
	...
	<td>
	<input type="checkbox" class="boSelect" name="applicationID" value="${approvedStudent.applicationID}#${approvedStudent.meritType}">
	</td> 
                                 ...
                                 <div style="width:140px;float: right;right-padding:0cm">
                                 	<input type="hidden" name="formAction" id="formAction" value="" />
                                  	<input type="submit" style="width:130px;padding: 1px 12px;" class="btn btn-info" name="cancel" value="Cancel Admission" />
                                </div>
