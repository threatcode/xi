...
<table style="border: 1px solid black;margin-right: auto;margin-left: 69px;width: 80%;">
	...
	<tr><td style="padding-left: 10px;height: 30px">6<td>Al Fiquh					(203)
	<tr><td style="padding-left: 10px;height: 30px">7<td>Arabic 					(223)
	<tr><td style="padding-left: 10px;height: 30px">8<td>Tazbid 					(232, 233)
	<tr><td style="padding-left: 10px;height: 30px">9<td>Quirati Tartil				(234)
	<tr><td style="padding-left: 10px;height: 30px">10<td>Quirati Hadar 			(235)	
	...
	<tr><td style="padding-bottom: 20px;padding-left: 10px;height: 30px">11<td><select id="sub7s" name="sub7s"  style="width: 242px" onchange="sub7change()" tabindex="8">
											<option value="" selected>Select Optional Subject</option>
														<c:forEach items="${session.collegeSubject}" var="cs" varStatus="loop">
															<c:if test="${cs.group_id=='10'}">
