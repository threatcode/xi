...
<table style="border: 1px solid black;margin-right: auto;margin-left: 69px;width: 80%;">
	...
	<tr><td style="padding-left: 10px;height: 30px">4<td>Light Song   (216, 217)
	<tr><td style="padding-left: 10px;height: 30px">5<td>Classical Music (218, 219)
