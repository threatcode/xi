...
<div class="center_content">
	<div id="right_wrap">
		<div id="right_content">
			...
			<h2> Receive Admission</h2>
			<div class="sidebar_section_text">
			<div class="box_row" style="background-color: #1874cd;color: white;text-align: left;font-weight: bold;padding-top: 0px;font-size: 18px; padding-top: 6px; padding-bottom: 6px; border-radius: 6px; border: 1px solid #00A3FF; box-shadow: 0px 0px 12px #888888;">
							<center>Non-Approved Students List</center>
						</div>
...
<td style="color:black;"><strong>Merit Type</strong></td>
 -->
<td style="color:black;display: none" id="thsscroll"><strong>SSC Roll</strong></td>
...
<!-- 
<td>
<select name="meritType" id="meritType" onchange="changeMerit(this)">
...
<div class="box_row" style="background-color: lightblue;color: red;text-align: left;font-weight: bold;padding-top: 0px;font-size: 18px; padding-top: 6px; padding-bottom: 6px; border-radius: 6px; border: 1px solid #00A3FF; box-shadow: 0px 0px 12px #888888;">
							<center>After selecting students for approval, you have to click Receive Admission button.</center>
						</div>
...
function validateMobileNumber(mobileNumber) {
    ...
    function searchStudent() {
        ...
        */
        ...
        $.ajax({
            type    : "POST",
            url     : "nonApprovedStudentListOfMerit1",
            dataType: 'text',
            async   : false,
            data    : {
