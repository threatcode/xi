...
var uniqueEIINs=[];
var bengaliNumber= ["&#2534;", "&#2535;", "&#2536;", "&#2537;", "&#2538;", "&#2539;", "&#2540;", "&#2541;", "&#2542;", "&#2543;"];
var numbersj_p = ["Zero", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine"];
var numbersbfj_p = ["&#2486;&#2498;&#2472;&#2509;&#2479;", "&#2447;&#2453;", "&#2470;&#2497;&#2439;", "&#2468;&#2495;&#2472;", "&#2458;&#2494;&#2480;", "&#2474;&#2494;&#2433;&#2458;", "&#2459;&#2479;&#2492;", "&#2488;&#2494;&#2468;", "&#2438;&#2463;", "&#2472;&#2479;&#2492;"];
 ...
 function validateSscInfo(){
	 ...
	 */
	 ...
	 $("#personal_info_div").html("<img src='/board/resources/images/239.gif' />");
		 $.ajax({
			 	url: 'appCheckDelwar_TT',		
			 	type: 'POST',
			 	data: {ssc_roll:$("#ssc_roll").val(),ssc_board:$("#ssc_board").val(),ssc_year:$("#ssc_year").val(),ssc_reg:$("#ssc_reg").val(),
			 		user_captcha:$("#user_captcha").val(),java_captcha:$("#java_captcha").val()},
			 	success: function(data) {
			 		//$('#user_captcha').attr("readonly", true);sscnext
			 		//$('#sscnext').prop("disabled", true);
			 	...
			 	if(data=="ce")
			 	{
			 		...
			 		var currrentHTML='<div class="errorPromptDiv"><div class="promptDivIcon">&#9587;</div><div class="promptDivMessage">'+"&#2470;&#2527;&#2494; &#2453;&#2480;&#2503; &#2453;&#2509;&#2479;&#2494;&#2474;&#2458;&#2494; &#2463;&#2503;&#2453;&#2509;&#2488;&#2463;&#2463;&#2495; &#2488;&#2464;&#2495;&#2453;&#2477;&#2494;&#2476;&#2503; &#2463;&#2494;&#2439;&#2474; &#2453;&#2480;&#2497;&#2472;&#2404;<br/><br/>Please type the Captcha text accurately."+'</div></div>';
			 		$('#CollegeDetailsPopUpContainerDiv').remove();
			 		var y='<div id="CollegeDetailsPopUpContainerDiv">'+currrentHTML+"</div>";
			 		showPopUpWindowWithMask(y, popUpWindowWidth, popUpWindowHeight);
			 		setTimeout(function() { $("#ssc_roll").val('');
			 		$("#ssc_reg").val('');
			 		$("#user_captcha").val('');
			 		location.reload();
			 		exit; }, 5000);
			 	...
			 	if(data.indexOf("validateTxInfo") >= 0)                //data.includes("validateTxInfo"))
			 	{
					...
					$("#tx_info_div").html(data);
			 		$('#tx_captcha').unbind();
			 		$('#tx_captcha').bind("cut",function(e) {
			 	        e.preventDefault();
			 	    });
			 		$('#tx_captcha').bind("copy",function(e) {
			 	        e.preventDefault();
			 	    });
			 		$('#tx_captcha').bind("paste",function(e) {
			 	        e.preventDefault();
			 	    });
			 	    $("#personal_info_div").html("");
			 	   $("#captchaImg_tx").attr("src","captcha?"+new Date());
			 	}
			 	else
			 	{
			 		...
			 		/*
			 		if($("#ssc_board").val()=='20' && $("#p_birth_date").val()=='')
			 		{
			 			alert('We donot have your birth date, please fillup your birth date!!!');
			 			...
			 			$('#p_birth_date').attr("readonly", false); 
			 			$('#p_birth_date').prop("disabled", false);
			 			$("#agediv").css("display","block");
			 		}
			 		*/
			 		$('#mobile_number').unbind(); $('#confirm_mobile_number').unbind();
			 		
			 		$('#mobile_number').bind("cut",function(e) {e.preventDefault();});
			 		$('#mobile_number').bind("copy",function(e) {e.preventDefault();});
			 		$('#mobile_number').bind("paste",function(e) {e.preventDefault();});
			 		
			 		$('#confirm_mobile_number').bind("cut",function(e) {e.preventDefault();});
			 		$('#confirm_mobile_number').bind("copy",function(e) {e.preventDefault();});
			 		$('#confirm_mobile_number').bind("paste",function(e) {e.preventDefault();});
			 		
			 		//$('#nid_number').unbind(); $('#confirm_nid_number').unbind();
			 		
			 		$('#nid_number').bind("cut",function(e) {e.preventDefault();});
			 		$('#nid_number').bind("copy",function(e) {e.preventDefault();});
			 		$('#nid_number').bind("paste",function(e) {e.preventDefault();});
			 		
			 		//$('#confirm_nid_number').bind("cut",function(e) {e.preventDefault();});
			 		//$('#confirm_nid_number').bind("copy",function(e) {e.preventDefault();});
			 		//$('#confirm_nid_number').bind("paste",function(e) {e.preventDefault();});
...
function validateTxInfo(){
	 ...
	 var valid=validateField("ssc_roll","ssc_board","ssc_year","ssc_reg","tx_captcha","organization","trxid");
	 if(valid==true){
	 $("#personal_info_div").html("<img src='/board/resources/images/239.gif' />");
		 $.ajax({
			 	url: 'applicationInfoCheckTx_TT',		
			 	type: 'POST',
			 	data: {trxid:$("#trxid").val(),ssc_roll:$("#ssc_roll").val(),ssc_board:$("#ssc_board").val(),ssc_year:$("#ssc_year").val(),ssc_reg:$("#ssc_reg").val(),
			 		tx_captcha:$("#tx_captcha").val(),java_captcha:$("#java_captcha").val(),organization:$("#organization").val()},			 	
			 	success: function(data) {
					if(data=="ce")
				 	{
...
function goForUpdateApplicationChooses(){
	 ...
	 $("#personal_info_div").html("<img src='/board/resources/images/239.gif' />");
		 $.ajax({
			 	...
			 	type: 'POST',
			 	data: {ssc_roll:$("#ssc_roll").val(),ssc_board:$("#ssc_board").val(),ssc_year:$("#ssc_year").val(),ssc_reg:$("#ssc_reg").val(),scode:sscode,contactno:Vcontactno},
			 	success: function(data) {
			 		$("#personal_info_div").html(data);
			 		setTimeout(function() { saveLoadTimeQuotas(); }, 400);
			 	},
			 	error: function(e) {
			 	}
		 		});
...
function collegeSelection(){
	...
	if($("#ssc_board").val()=='20' && $("#p_birth_date").val().trim()=='')
	{
		...
		$("#college_selection_container").hide();
		return;
	}
	else
	{
		...
		var datemain = new Date(1997, 1, 1, 0, 0, 0, 0);
		if(datedob<datemain)
		{
	...
	*/
	...
	if(!($("#nid_number").val().length==0 ||  $("#nid_number").val().length==10 || $("#nid_number").val().length==13 || $("#nid_number").val().length==17))
	{
	...
	/*
	var validNID=validateField("nid_number","confirm_nid_number");
	if(!validNID)
	{
	...
	*/
	...
	if(valid){
	 $.ajax({
		 	url: 'checkContact',		
		 	type: 'POST',
		 	data: {contactno:$("#mobile_number").val()},
		 	success: function(data) {
		 		...
		 		if(data=="no")
			 	{
					...
					var currrentHTML='<div class="errorPromptDiv"><div class="promptDivIcon">&#9587;</div><div class="promptDivMessage">'+"&#2437;&#2480;&#2509;&#2469; &#2474;&#2480;&#2495;&#2486;&#2507;&#2471; &#2453;&#2480;&#2494;&#2480; &#2488;&#2478;&#2527; &#2438;&#2474;&#2472;&#2495; &#2479;&#2507;&#2455;&#2494;&#2479;&#2507;&#2455;&#2503;&#2480; &#2472;&#2478;&#2509;&#2476;&#2480; &#2489;&#2495;&#2488;&#2503;&#2476;&#2503; &#2438;&#2480;&#2503;&#2453;&#2463;&#2495; &#2478;&#2507;&#2476;&#2494;&#2439;&#2482; &#2472;&#2478;&#2509;&#2476;&#2480; &#2470;&#2495;&#2479;&#2492;&#2503;&#2459;&#2503;&#2472;&#2404; &#2470;&#2479;&#2492;&#2494; &#2453;&#2480;&#2503; &#2488;&#2503;&#2439; &#2479;&#2507;&#2455;&#2494;&#2479;&#2507;&#2455;&#2503;&#2480; &#2472;&#2478;&#2509;&#2476;&#2480;&#2463;&#2495; &#2474;&#2509;&#2480;&#2470;&#2494;&#2472; &#2453;&#2480;&#2497;&#2472;&#2404; <br/></br/>You have given another mobile number as contact number during the payment process. Please provide that contact number."+'</div></div>';
				    $('#CollegeDetailsPopUpContainerDiv').remove();
					var y='<div id="CollegeDetailsPopUpContainerDiv">'+currrentHTML+"</div>";
				    showPopUpWindowWithMask(y, popUpWindowWidth, popUpWindowHeight);
				 		//alert('You have paid with another mobile number');
			 			//$("#mobileinfo").html("<font color=\"red\" size=\"4\">You have paid with another mobile number.</font>");
			 			//$("#pnext").hide();
			 	}
			 	else
			 	{
				    $("#college_selection_container").html(data);
				    $("#college_selection_container").show();
					$("#mobile_number").addClass("inputDisabledSak");
					$("#confirm_mobile_number").addClass("inputDisabledSak");
					$('#nidholder').prop('disabled', 'disabled');
					//$("#nidholder").attr("readonly","readonly");
					//$("#nidholder option:selected").attr('disabled','disabled').siblings().removeAttr('disabled');
					$("#nid_number").addClass("inputDisabledSak");
					//$("#confirm_nid_number").addClass("inputDisabledSak");
					//$("#p_birth_date").addClass("inputDisabledSak");
					$('#mobile_number').attr("readonly", true); //$('#confirm_mobile_number').attr("readonly", true); 
					$('#nid_number').attr("readonly", true); //$('#confirm_nid_number').attr("readonly", true); 
		 		...
		 		if(data=="yes")
			 	{
					...
					$("#confirm_mobile_number").addClass("inputDisabledSak"); 
		 			enableField("submitButton");
		 			 ...
		 			 clearHtml("college_selection_container");
		 			 clearColegeSelection();
		 			 $("#response_div").hide();
		 			document.getElementById("college_selection_container").style.minHeight = "400px"
		 			 
		 			 
		 				

		 			 $("#college_selection_container").html("<img src='/board/resources/images/239.gif' />");
		 				 $.ajax({
		 				       ...
		 				       $("#college_selection_container").show();
		 				       setTimeout(function() { saveLoadTimeQuotas(); saveLoadTimeSelections(); }, 1000);
	...
	document.getElementById("college_selection_container").style.minHeight = "400px"
	 ...
	 $("#college_selection_container").html("<img src='/board/resources/images/239.gif' />");
		 $.ajax({
		       ...
		       $("#college_selection_container").show();
		       setTimeout(function() { saveLoadTimeSelections(); }, 1000);
		       scrollToBottom();
	
	
}

function collegeSelectionSMSOnly(){
	 enableField("submitButton");
	 $("#submitButton").css('background-color', 'buttonface');		
	 clearHtml("college_selection_container");
	 clearColegeSelection();
...
function checkTotalSeat(shift_id,version_id,group_id)
{
    ...
    sshowseatcount.push(collegeSVG.total_seat1[eKey1]);
...
/* 	if(from_where=="R" || from_where=="S"){ 		
    ...
    else if(from_where=='O' || from_where=='U')
    ...
    row.push("<td align='center'>"+rowIndex+"</td>",
		  ...
		  "<td align='center'>"+special_quota+"</td>"+""//"<td align='center'>"+gb_quota+"</td>"
		  );
    ...
    row.push("<td align='center'><input type='text' name='choice["+rowIndex+"].priority' id='priority_"+rowIndex+"' value='"+rowIndex+"' style='width:30px;text-align:center;'>",
//    		row.push("<td align='center'>",
		  		...
		  		//"<input type='hidden' name='choice["+rowIndex+"].gb_quota' value='"+gb_quota+"' />",		  		
		  		"<input type='hidden' name='choice["+rowIndex+"].application_type' value='WEB' />",
		  		"<input type='hidden' name='choice["+rowIndex+"].mobile_no' value='' />");
    ...
    row.push("<td><img class='newlyAddedRow' id='img_delete_"+rowIndex+"' src='/board/resources/images/trash.gif' style='cursor:pointer' onclick=\"deleteChoice("+rowIndex+",'"+from_where+"')\"/>",
		  "</td>",
		  "</tr>");
	...
	$('#selection_row_table').find('tr').each(function (rowIndex, r) 
		{
			...
			if(rowIndex>0)
			{
				var currentRowId=$(this).attr('id');
					...
					var currentRemoveImage=$(currentRow.cells[8]).children('img');
					//currentRemoveImage.html('F');
					//alert(currentRemoveImage.html());
					currentRemoveImage.attr('onclick','').unbind( "click" );
					currentRemoveImage.click(function(){
						deleteChoice(rowIndex,'O');
					});
					currentRowId=currentRowId.substr(4);
					//var currentPriorityName='choice['+currentRowId+'].priority';
					//$('td[name=tcol1]')
					...
					$("[name='choice["+currentRowId+"].priority']").attr("id","priority_"+rowIndex);
					$("[name='choice["+currentRowId+"].priority']").attr("name",'choice['+rowIndex+'].priority');
					$("[name='choice["+currentRowId+"].eiin']").attr("name",'choice['+rowIndex+'].eiin');
					$("[name='choice["+currentRowId+"].shift_id']").attr("name",'choice['+rowIndex+'].shift_id');
					$("[name='choice["+currentRowId+"].version_id']").attr("name",'choice['+rowIndex+'].version_id');
					$("[name='choice["+currentRowId+"].group_id']").attr("name",'choice['+rowIndex+'].group_id');
					$("[name='choice["+currentRowId+"].special_quota']").attr("name",'choice['+rowIndex+'].special_quota');
					$("[name='choice["+currentRowId+"].gb_quota']").attr("name",'choice['+rowIndex+'].gb_quota');
					$("[name='choice["+currentRowId+"].application_type']").attr("name",'choice['+rowIndex+'].application_type');
					$("[name='choice["+currentRowId+"].mobile_no']").attr("name",'choice['+rowIndex+'].mobile_no');
			}
			/*
...
/*    if(from_where=='A' || from_where=='R' ||  from_where=='S'){
	...
	if(index>0) {
		...
		$(this).attr('id','row_'+index);
  	    ...
  	    $cells.each(function(cellIndex,c){ 
	...
	$.ajax({
		...
		success: function(data) {
			...
			if(data.status=='OK'){
				...
				var currentHTML=getSuccessResponseContent(data.sscInfo.student_name,data.application_id,data.scode,data.sscInfo.board_name);
				var popUpWindowHeight= 420;
				var popUpWindowWidth=600;	
				$('#CollegeDetailsPopUpContainerDiv').remove();
				var y='<div id="CollegeDetailsPopUpContainerDiv">'+currentHTML+"</div>";
			    showPopUpWindowWithMask(y, popUpWindowWidth, popUpWindowHeight);			
				...
				var currrentHTML='<div class="errorPromptDiv"><div class="promptDivIcon">&#9587;</div><div class="promptDivMessage">'+data.message+'</div></div>';
			    $('#CollegeDetailsPopUpContainerDiv').remove();
				var y='<div id="CollegeDetailsPopUpContainerDiv">'+currrentHTML+"</div>";
			    showPopUpWindowWithMask(y, popUpWindowWidth, popUpWindowHeight);
			}
				...
				var alertMessage="&#2470;&#2497;&#2435;&#2454;&#2495;&#2468;! &#2438;&#2474;&#2472;&#2494;&#2480; &#2438;&#2476;&#2503;&#2470;&#2472; &#2474;&#2509;&#2480;&#2453;&#2509;&#2480;&#2495;&#2527;&#2494; &#2488;&#2478;&#2509;&#2474;&#2472;&#2509;&#2472; &#2489;&#2527; &#2472;&#2495;&#2404; &#2470;&#2527;&#2494; &#2453;&#2480;&#2503; &#2486;&#2497;&#2480;&#2497; &#2469;&#2503;&#2453;&#2503; &#2438;&#2476;&#2503;&#2470;&#2472; &#2474;&#2509;&#2480;&#2453;&#2509;&#2480;&#2495;&#2527;&#2494;&#2463;&#2495; &#2486;&#2497;&#2480;&#2497; &#2453;&#2480;&#2497;&#2472;&#2404;<br/><br/>Sorry! Your application submission procedure is not completed yet. Please restart the application procedure from the beginning.";
				var currrentHTML='<div class="errorPromptDiv"><div class="promptDivIcon">&#9587;</div><div class="promptDivMessage">'+alertMessage+'</div></div>';
			    $('#CollegeDetailsPopUpContainerDiv').remove();
				var y='<div id="CollegeDetailsPopUpContainerDiv">'+currrentHTML+"</div>";
			    showPopUpWindowWithMask(y, popUpWindowWidth, popUpWindowHeight);
	...
	$.ajax({
		...
		success: function(data) {
			...
			if(data.status=='OK'){
				...
				var currentHTML=getSuccessResponseContentEdit(data.sscInfo.student_name,data.application_id,data.scode, data.sms,data.sscInfo.board_name);
				var popUpWindowHeight= 420;
				var popUpWindowWidth=600;	
				$('#CollegeDetailsPopUpContainerDiv').remove();
				var y='<div id="CollegeDetailsPopUpContainerDiv">'+currentHTML+"</div>";
...
*/			
	...
	$("#selection_row_table tr").each(function(index) {
		//var abcd = $(this).find('td:eq(8)').html();
		//if($(this).find('td:eq(8)').html().includes('trash.gif'))
		...
		if(index>0) {
			...
			row.push($(this).find('td:eq(0)').html(),"#",
					 ...
					 $(this).find('td:eq(7)').children('input').val(),"#",apptype,'#',"@@"
					);
			row_str=row.join("");
	    } 
    });
...
function isPriorityOk(from_where){
	...
	//alert(from_where);
	var priority_index;
    if(from_where=='A' || from_where=='R' || from_where=='S'|| from_where=='E'){
    	priority_index=9;
    }
    else if (from_where=='U' || from_where=='O') {
    	priority_index=7;
    }
    else{
    	priority_index=8;
...
function getSuccessResponseContent(applicant_name,application_id,password,board_name){
	 var div_content = [];
	 /*div_content.push(
			  "Dear Applicant,<br/><br/>",
			  "We have successfully received your online application.<br/>",
			  "<b>Applicant Name</b> : "+applicant_name+"</br>",
//			  "<b>Security Code</b> : "+password+"</br><font color=\"red\" size=\"4\">Please keep this code for future use.</font></br></br>",
...
//			  "<a href='../board/login' style='font-weight:bold;'>Click here</a> to login.<br/><br/>",
			  "<input type='button' value='Print Version' class='htmlReportBtn' onclick=\"javascript:void window.open('applicantCopyHtmlReport_TT','1433313485446','width=780,height=800,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');\" />");
	...
	*/
		...
		if(board_name=='BOU')
		{
			...
			bouheight='style="overflow-y: scroll; height:200px;"';
		}
		var currentHTML='<div class="successMessageDiv" ><b>Dear Applicant,</b><br/><br/>'+
				  ...
				  '<div class="securityCode" '+bouheight+'>'+
				  boutext1+
				  '&#2438;&#2474;&#2472;&#2494;&#2480; Contact &#2478;&#2507;&#2476;&#2494;&#2439;&#2482;&#2503; &#2540;(&#2459;&#2527;) &#2465;&#2495;&#2460;&#2495;&#2463;&#2503;&#2480; &#2447;&#2453;&#2463;&#2495; &#2455;&#2507;&#2474;&#2472;&#2496;&#2527; &#2488;&#2495;&#2453;&#2495;&#2441;&#2480;&#2495;&#2463;&#2495; &#2453;&#2507;&#2465; &#2474;&#2494;&#2464;&#2494;&#2472;&#2507; &#2489;&#2527;&#2503;&#2459;&#2503;&#2404; &#2477;&#2476;&#2495;&#2487;&#2509;&#2479;&#2468;&#2503; &#2437;&#2509;&#2479;&#2494;&#2474;&#2509;&#2482;&#2495;&#2453;&#2503;&#2486;&#2494;&#2472; &#2474;&#2480;&#2495;&#2470;&#2480;&#2509;&#2486;&#2472;/&#2474;&#2480;&#2495;&#2476;&#2480;&#2509;&#2468;&#2472;/&#2474;&#2480;&#2495;&#2476;&#2480;&#2509;&#2471;&#2472;-&#2447;&#2480; &#2460;&#2472;&#2509;&#2479; &#2447;&#2463;&#2495; &#2437;&#2476;&#2486;&#2509;&#2479;&#2439; &#2488;&#2434;&#2480;&#2453;&#2509;&#2487;&#2472; &#2453;&#2480;&#2497;&#2472;&#2404;  <br/><br>'+
				  boutext2+
				  'A 6 (Six) digit security code has been sent to your Contact Mobile number. It will be required for future Access/Modification. Please store it securely.<br/></div>'+
				  '<br/><div class="applicantDetails"><b>Applicant Name</b> : '+applicant_name+"</div></br>"+
		...
		if(board_name=='BOU')
		{
			currentHTML='<font size="2">'+currentHTML+'</font>';
		}
...
function getSuccessResponseContentEdit(applicant_name,application_id,password, sms_sent,board_name)
{
	 /*var div_content = [];
	 div_content.push(
			  "Dear Applicant,<br/><br/>",
	...
	if(sms_sent=="yes")
	{
		currentHTML+='<div class="securityCode" '+bouheight+'>'+
		  			boutext1+
					'&#2438;&#2474;&#2472;&#2494;&#2480; Contact &#2478;&#2507;&#2476;&#2494;&#2439;&#2482;&#2503; &#2540;(&#2459;&#2527;) &#2465;&#2495;&#2460;&#2495;&#2463;&#2503;&#2480; &#2447;&#2453;&#2463;&#2495; &#2455;&#2507;&#2474;&#2472;&#2496;&#2527; &#2488;&#2495;&#2453;&#2495;&#2441;&#2480;&#2495;&#2463;&#2495; &#2453;&#2507;&#2465; &#2474;&#2494;&#2464;&#2494;&#2472;&#2507; &#2489;&#2527;&#2503;&#2459;&#2503;&#2404; &#2477;&#2476;&#2495;&#2487;&#2509;&#2479;&#2468;&#2503; &#2437;&#2509;&#2479;&#2494;&#2474;&#2509;&#2482;&#2495;&#2453;&#2503;&#2486;&#2494;&#2472; &#2474;&#2480;&#2495;&#2470;&#2480;&#2509;&#2486;&#2472;/&#2474;&#2480;&#2495;&#2476;&#2480;&#2509;&#2468;&#2472;/&#2474;&#2480;&#2495;&#2476;&#2480;&#2509;&#2471;&#2472;-&#2447;&#2480; &#2460;&#2472;&#2509;&#2479; &#2447;&#2463;&#2495; &#2437;&#2476;&#2486;&#2509;&#2479;&#2439; &#2488;&#2434;&#2480;&#2453;&#2509;&#2487;&#2472; &#2453;&#2480;&#2497;&#2472;&#2404;  <br/>'+
					boutext2+
	...
	if (bengaliNumber[currentUpdateCount] != undefined && currentUpdateCount != null) 
	{
		currentUpdateCount=parseInt(parseInt(currentUpdateCount)+1);
		//currentHTML+='<div class="updateCountShow">&#2468;&#2497;&#2478;&#2495; &#2439;&#2468;&#2495;&#2478;&#2471;&#2509;&#2479;&#2503; &#2468;&#2507;&#2478;&#2494;&#2480; &#2437;&#2509;&#2479;&#2494;&#2474;&#2509;&#2482;&#2495;&#2453;&#2503;&#2486;&#2472;&#2463;&#2495; '+(bengaliNumber[currentUpdateCount])+' &#2476;&#2494;&#2480; &#2438;&#2474;&#2465;&#2503;&#2463; &#2453;&#2480;&#2503;&#2459;&#2404 &#2468;&#2497;&#2478;&#2495; &#2468;&#2507;&#2478;&#2494;&#2480; &#2474;&#2509;&#2480;&#2470;&#2468;&#2509;&#2468; &#2468;&#2469;&#2509;&#2479; &#2438;&#2476;&#2503;&#2470;&#2472; &#2488;&#2478;&#2527;&#2488;&#2496;&#2478;&#2494;&#2480; &#2478;&#2471;&#2509;&#2479;&#2503; &#2488;&#2480;&#2509;&#2476;&#2507;&#2458;&#2509;&#2458; &#2539; (&#2474;&#2494;&#2433;&#2458;) &#2476;&#2494;&#2480; &#2474;&#2480;&#2495;&#2476;&#2480;&#2509;&#2468;&#2472; &#2453;&#2480;&#2468;&#2503; &#2474;&#2494;&#2480;&#2476;&#2503;&#2404; <br/><br/> You have already updated your application '+(currentUpdateCount)+' times. You can update your information at most 5 (five) times within the application deadline. </div>';
		currentHTML+='<div class="updateCountShow" '+bouheight+'>'+
					boutext1+
					'&#2438;&#2474;&#2472;&#2495; &#2439;&#2468;&#2495;&#2478;&#2471;&#2509;&#2479;&#2503; &#2438;&#2474;&#2472;&#2494;&#2480; &#2438;&#2476;&#2503;&#2470;&#2472;&#2463;&#2495; '+(bengaliNumber[currentUpdateCount])+' ('+numbersbfj_p[currentUpdateCount]+') &#2476;&#2494;&#2480; &#2438;&#2474;&#2465;&#2503;&#2463; &#2453;&#2480;&#2503;&#2459;&#2503;&#2472; &#2438;&#2474;&#2472;&#2495; &#2438;&#2476;&#2503;&#2470;&#2472; &#2488;&#2478;&#2479;&#2492;&#2488;&#2496;&#2478;&#2494;&#2480; &#2478;&#2471;&#2509;&#2479;&#2503; &#2438;&#2474;&#2472;&#2494;&#2480; &#2468;&#2469;&#2509;&#2479; &#2488;&#2480;&#2509;&#2476;&#2494;&#2471;&#2495;&#2453; &#2539; (&#2474;&#2494;&#2433;&#2458;) &#2476;&#2494;&#2480; &#2438;&#2474;&#2465;&#2503;&#2463; &#2453;&#2480;&#2468;&#2503; &#2474;&#2494;&#2480;&#2503;&#2472; <br/><br/> '+
					boutext2+
					'You have already updated your application '+(currentUpdateCount)+' ('+numbersj_p[currentUpdateCount]+') '+((currentUpdateCount>1) ? 'times' : 'time')+'. You can update your information at most 5 (five) times within the application deadline </div>';
	}		
	currentHTML+='<br/><div class="applicantDetails"><b>Applicant Name</b> : '+applicant_name+"</div></br>"+
	//			  "<b>Security Code</b> : "+password+"</br><font color=\"red\" size=\"4\">Please keep this code for future use.</font></br></br>"+
	//			  "<b>Password</b> : "+password+"</br>"+
	//			  "<br/>"+
	//			  "<font style='color:red;font-weight:bold'>To Confirm your Application, please pay 150 Taka by a Teletalk Mobile - go to message option and</font><br/>",
