...
var arrYear = [2017,2016,2015];
var arrYearBOU = [2015,2014];
var arrBTEByear = [2017,2016,2015,2014,2013,2012,2011,2010,2009,2008];
var college_map = {}; 
...
function addChoice(from_where){
 	...
 	if(valid_code==1){
	    ...
	    $('#CollegeDetailsPopUpContainerDiv').remove();
		 ...
		 var alertMessage="A duplicate selection has been found.";
	 	 var popUpWindowHeight= 200;
		 var popUpWindowWidth=300;
	    ...
	    showPopUpWindowWithMask(y, popUpWindowWidth, popUpWindowHeight);
 		return;
			 	...
			 	var alertMessage="Sorry, the selected choice (gender & other criteria) is not valid for you.";
			 	var popUpWindowHeight= 200;
				var popUpWindowWidth=300;
	 ...
	 if(!isAlreadyExists && distinctCollegeCount>=10){
		...
		var alertMessage="You have already selected 10 different colleges.";
	...
	$.ajax({
		...
		success: function(data) {
			...
			if(data.status=='OK'){
				...
				var currentHTML=getSuccessResponseContent(data.sscInfo.student_name,data.application_id,data.scode);
	...
	$.ajax({
		...
		success: function(data) {
			...
			if(data.status=='OK'){
				...
				var currentHTML=getSuccessResponseContentEdit(data.sscInfo.student_name,data.application_id,data.scode, data.sms);
				var popUpWindowHeight= 420;
				var popUpWindowWidth=600;	
				$('#CollegeDetailsPopUpContainerDiv').remove();
				var y='<div id="CollegeDetailsPopUpContainerDiv">'+currentHTML+"</div>";
...
function getSuccessResponseContentEdit(applicant_name,application_id,password, sms_sent)
{
	 /*var div_content = [];
	 div_content.push(
			  "Dear Applicant,<br/><br/>",
