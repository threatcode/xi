...
//	 @Action(value = "captcha", fault = {@Result(type="stream", params = {"contentType", "image/jpeg"})})
	 private InputStream inputStream;
	  public String captcha() {
	    try {
	      Captcha captcha = new Captcha.Builder(160, 40).addText(new NumbersAnswerProducer()).gimp(new BlockGimpyRenderer()).build();
	...
	public String getResult()
	{
		...
		if(!user_captcha.equalsIgnoreCase(checkSum)){
			try {
				...
				//meritTable += "<input type=\"button\" class=\"myButton green\" id=\"clearButton\" value=\"Refresh This Page\" onclick=\"clearButton()\"/>";
		...
		try {
			...
			tmp = getResultFromRMI(ssc_roll.trim(), ssc_board.trim(), ssc_year.trim(), ssc_reg.trim());
			resultlocation = "memory";
			if(tmp==null) {
				tmp = ApplicationDAO.getResultByApplicant(ssc_roll.trim(), ssc_board.trim(), ssc_year.trim(), ssc_reg.trim());
				resultlocation = "database";
			}
			if(tmp==null)resultlocation = "none";
			double endTime1 = System.nanoTime(); 
			System.out.println("Duration1 : "+resultlocation+" : "+(endTime1 - startTime1)/1000000);
		...
		if(tmp!=null)
		{
			if(tmp.getMerit_type()==null)
			{
				...
				meritTable += "<div class=\"applicantDetails\"><b>Applicant Name</b> : "+tmp.getName()+"</div>";
				meritTable += "<div  class=\"successResultMessage red\">" +
...
//						"&#2474;&#2480;&#2476;&#2480;&#2509;&#2468;&#2496;&#2468;&#2503; &#2476;&#2495;&#2477;&#2495;&#2472;&#2509;&#2472; &#2474;&#2509;&#2480;&#2468;&#2495;&#2488;&#2509;&#2464;&#2494;&#2472;&#2503; &#2438;&#2488;&#2472; &#2454;&#2494;&#2482;&#2495; &#2469;&#2494;&#2453;&#2494; &#2488;&#2494;&#2474;&#2503;&#2453;&#2509;&#2487;&#2503; &#2437;&#2472;-&#2482;&#2494;&#2439;&#2472;&#2503; &#2477;&#2480;&#2509;&#2468;&#2495;&#2480; &#2476;&#2509;&#2479;&#2476;&#2488;&#2509;&#2469;&#2494; &#2453;&#2480;&#2494; &#2489;&#2476;&#2503;&#2404;</div>";
			...
			{
				if(!(tmp.getMerit_type().equalsIgnoreCase("2") || tmp.getMerit_type().equalsIgnoreCase("4")))
				{
					String shift="";
					...
					else if(tmp.getVERSION_ID().equalsIgnoreCase("2"))version="English";
					...
					meritTable += "<center><div class=\"applicantDetails\"><b>Applicant Name</b> : "+tmp.getName()+"</div>";
					...
					meritTable += "<tr>" +
						          ...
						          "</tr>";
					meritTable += "<tr><td align=\"left\">"+tmp.getCOLLEGE_NAME()+"<td align=\"center\">"+tmp.getEIIN()
...
//			else if((tmp.getAppliedsms().equalsIgnoreCase("Y") || tmp.getAppliedweb().equalsIgnoreCase("Y")) && (tmp.getMerit_type()==null || tmp.getMerit_type().equalsIgnoreCase("")))
//			{
...
//			{
//				// applied and chance in first merit + migration applied + migration chance
//				String shift="";
//				if(tmp.getSHIFT_ID().equalsIgnoreCase("1"))shift="Morning";
//				else if(tmp.getSHIFT_ID().equalsIgnoreCase("2"))shift="Day";
//				else if(tmp.getSHIFT_ID().equalsIgnoreCase("3"))shift="Evening";
...
//				}				
//			}
//			else if((tmp.getMerit_type()!=null || !tmp.getMerit_type().equalsIgnoreCase("")) && !tmp.getStatus().equalsIgnoreCase("MIGRATED"))      //tmp.getStatus().equalsIgnoreCase("NEW SELECTION"))
//			{
...
//			tmp = getResultFromRMI(ssc_roll.trim(), ssc_board.trim(), ssc_year.trim(), ssc_reg.trim());
			resultlocation = "memory";
			if(tmp==null) {
				tmp = ApplicationDAO.getResultByApplicant_Final(ssc_roll.trim(), ssc_board.trim(), ssc_year.trim(), ssc_reg.trim());
				resultlocation = "database";
			}
			if(tmp==null)resultlocation = "none";
			double endTime1 = System.nanoTime(); 
	...
	public String getResult1()
	{
		...
		if(user_captcha.equalsIgnoreCase(checkSum)){
			...
			try {
				...
				double endTime1 = System.nanoTime(); 
//				System.out.println("Duration1 : "+(endTime1 - startTime1)/1000000);
			} catch (Exception e) {
				// TODO: handle exception
			}
			String meritTable = "";
...
//				else if(tmp.getSHIFT_ID().get(i).equalsIgnoreCase("2"))shift="Day";
//				else if(tmp.getSHIFT_ID().get(i).equalsIgnoreCase("3"))shift="Evening";
//				String version="";
//				if(tmp.getVERSION_ID().get(i).equalsIgnoreCase("1"))version="Bangla";
//				else if(tmp.getVERSION_ID().get(i).equalsIgnoreCase("2"))version="English";
//				meritTable += "<tr><td align=\"left\">"+tmp.getCOLLEGE_NAME().get(i)+"<td align=\"center\">"+tmp.getEIIN().get(i)
...
//			}
			...
			{
				String shift="";
				if(tmp.getSHIFT_ID().split("##")[i].equalsIgnoreCase("1"))shift="Morning";
				else if(tmp.getSHIFT_ID().split("##")[i].equalsIgnoreCase("2"))shift="Day";
				else if(tmp.getSHIFT_ID().split("##")[i].equalsIgnoreCase("3"))shift="Evening";
				String version="";
				if(tmp.getVERSION_ID().split("##")[i].equalsIgnoreCase("1"))version="Bangla";
				else if(tmp.getVERSION_ID().split("##")[i].equalsIgnoreCase("2"))version="English";
				meritTable += "<tr><td align=\"left\">"+tmp.getCOLLEGE_NAME().split("##")[i]+"<td align=\"center\">"+tmp.getEIIN().split("##")[i]
						+"<td align=\"center\">"+shift+"<td align=\"center\">"+version+"<td align=\"left\">"+tmp.getGROUP_NAME().split("##")[i]
						+"<td align=\"left\">"+tmp.getQUOTA_TYPE()+"<tr>";
			}
...
//			e.printStackTrace();
   ...
   public synchronized static Result getResultFromRMI(String roll, String board,String year,String reg)
    {
    	Result tmp =null;
    	try {
...
//	   contactno = "88"+contactno;
	   ...
	   if(session.get("contactno")!=null && contactno.equalsIgnoreCase((String)session.get("contactno")))
	   {
			try {
				response.setContentType("text/html");
...
//		checkCaptcha=true;
		...
		if(checkCaptcha){
			...
			{			
				...
				session.put("gpa", applicant.getSsc_info().getGpa());
				session.put("eiin", applicant.getSsc_info().getEiin());
				session.put("group_id", applicant.getSsc_info().getGroup_id());
...
//			else if(applicant.getMsg().equalsIgnoreCase("newappWithSMS"))
//			{
//				request.setAttribute("ssc_roll_app", ssc_roll);
//				request.setAttribute("ssc_board_app", ssc_board);
//				request.setAttribute("ssc_year_app", ssc_year);
...
//				session.put("webpayment", "no");
//				session.put("contactno", applicant.getContactno());
//				return "newappWithSMS";//"newappWithSMS";       //here should applicant choices 
//			}
//			else if(applicant.getMsg().equalsIgnoreCase("newappWithWEB"))
//			{
//				request.setAttribute("ssc_roll_app", ssc_roll);
//				request.setAttribute("ssc_board_app", ssc_board);
//				request.setAttribute("ssc_year_app", ssc_year);
...
//				return "updateEditApplication"; 
//			}
//			else if(applicant.getMsg().equalsIgnoreCase("complainwithPersonalInfo")) //added by joy
//			{
//				
//				request.setAttribute("ssc_roll_app", ssc_roll);
//				request.setAttribute("ssc_board_app", ssc_board);
...
//				session.put("ssc_reg", ssc_reg);
//				session.put("contactno", applicant.getContactno());
//				return "complainwithPersonalInfo"; 
//			}
//			else if(applicant.getMsg().equalsIgnoreCase("newappWithSMSNC"))
//			{
//				request.setAttribute("ssc_roll_app", ssc_roll);
//				request.setAttribute("ssc_board_app", ssc_board);
//				request.setAttribute("ssc_year_app", ssc_year);
...
//				session.put("ssc_reg", ssc_reg);
//				session.put("webpayment", "yes");
//				return "newappWithSMSNC";
//				//here should applicant choices 
//			}
...
//		}
		SscDataDAO sscDAO=new SscDataDAO();
		sscDAO.sentSecurityCode((String)session.get("ssc_roll"),(String)session.get("ssc_board"),(String)session.get("ssc_year"),
				(String)session.get("ssc_reg"));
		try {
			response.setContentType("text/html");
			response.getWriter().write("<font color=\"green\">Security code sent to your mobile. Please check your mobile number.</font>");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public String applicationInfoCheckTx_TT()
	{
		...
		if(tx_captcha.equalsIgnoreCase(checkSum)){
			///////////////////////           get TT information ////////////////////////////////////////
			if(organization.equalsIgnoreCase("SC-OLD"))
			{
				try{
...
//			                .appType("web")
			...
			if(organization.equalsIgnoreCase("BKash"))
			{
				try{
...
//					System.out.println(myResponse.getString("status").toLowerCase());
			...
			{
				try{
					String generatedJSONString = "{\"roll\" :\""+ssc_roll+"\",\"reg\" :\""+ssc_reg+"\",\"board\" :\""+getBoardName(ssc_board)+"\",\"year\" :\""+ssc_year+"\",\"apptype\" : \"web\",\"organization\" : \"TT\"}";
//					String myUrlgoeshere = "http://103.230.104.217:9999/CAD/buet2TTcheck.php";
					...
					if(myResponse.getString("status").toLowerCase().contains(("yes")))
					{
						...
						if(!ssc_roll.equalsIgnoreCase(myResponse.getString("roll").replaceAll("-", "")) || !ssc_reg.equalsIgnoreCase(myResponse.getString("reg").replaceAll("-", "")) || !ssc_year.equalsIgnoreCase(myResponse.getString("year")))
						{
							return "trxidOthers";
						}
						if(!myResponse.getString("apptype").equalsIgnoreCase("web"))
						{
							return "wait";
						}
						...
						applicant.setContactno(myResponse.getString("contactno"));
						applicant.setTrxid(myResponse.getString("trxid"));
						applicant.setPaytime(myResponse.getString("paytime"));
						applicant.setPaymobile(myResponse.getString("paymobile"));
						applicant.setRoll(myResponse.getString("roll"));
						applicant.setOrganization(myResponse.getString("organization"));
						ApplicationDAO adao = new ApplicationDAO();
						ResponseDTO rspDTO = adao.makeWebPayment(applicant, getSecurityCode());
						if(rspDTO.getStatus().equalsIgnoreCase("OK"))
							return "wait";
						else
						{
							request.setAttribute("asdasdasd", rspDTO.getMessage());
							return "error";
						}
					}
					else
			...
			if(organization.equalsIgnoreCase("SC"))
			{
				try{
			...
			if(organization.equalsIgnoreCase("SBL"))
			{
				try {
			...
			if(organization.equalsIgnoreCase("NAGAD"))
			{
				try {
					String baseUrl="https://ws-external.mynagad.com:8162/eduBoard/api/v1/getWebPayment";
					 String queryParams = "trxid="+trxid+"&organization=NAGAD"; 
			...
			if(organization.equalsIgnoreCase("Rocket"))
			{
				try{
					try {
	...
	private String callByHttpGet(String URL,String authorization,String paramData,
...
//		}
		...
		String generatedJSONString = "{\"apptype\" :\"web\",\"trxid\" : \""+trxid+"\",\"organization\" : \"SC\"}";
		StringEntity input = new StringEntity(generatedJSONString);
		input.setContentEncoding(new BasicHeader(HTTP.CONTENT_TYPE,"application/json;charset=UTF-8"));
		...
		if( authorization!=null ){
			request.setHeader("Authorization", "Basic " + Base64.encodeBase64String(authorization.getBytes()));
		}
		//LoggerUtils.printLog(LOG_HEADER, "--> REQ:", request.getURI().toString());
		HttpResponse response = null;
		String strResponse = null;
		try {
			HttpClient client = new DefaultHttpClient();
			response = client.execute(request);
			strResponse = (response.getEntity() != null) ? EntityUtils.toString(response.getEntity()) : null;
		} catch (Exception e) {
			e.printStackTrace();
		} 
		return strResponse;
	...
	public String PersonalInfoForChooseUpdate()
	{
		...
		if(!is_active.equals("1"))
		{
			Gson gson = new Gson();
			String json="";
			json = gson.toJson("<div class='msg_div' style='font-size: 24px; text-align: center; color: #EC0F18; background-color: #FDD0D0;	padding: 12px; border: 2px solid #FFCFD0;	border-radius: 5px;	box-shadow: 0px 0px 8px #888888;'>&#2438;&#2474;&#2472;&#2495; &#2438;&#2474;&#2472;&#2494;&#2480; &#2438;&#2476;&#2503;&#2470;&#2472; &#2539; (&#2474;&#2494;&#2433;&#2458;) &#2476;&#2494;&#2480;&#2503;&#2480; &#2458;&#2503;&#2479;&#2492;&#2503; &#2476;&#2503;&#2486;&#2495; &#2474;&#2480;&#2495;&#2476;&#2480;&#2509;&#2468;&#2472; &#2453;&#2480;&#2468;&#2503; &#2474;&#2494;&#2480;&#2476;&#2503;&#2472; &#2472;&#2494; <br/>You can not Update your application more than 5 (five) times</div>");
		...
		if(appScode.equals(scode)&& appContactno.equals(contactno) && no_of_update!=null && Integer.parseInt(no_of_update)<5)
		{
			SscDataDAO sscDAO=new SscDataDAO();
			ApplicationDAO.DeleteAPPCount(ssc_board+ssc_year+ssc_roll);
			applicant=sscDAO.getApplicationWId_TT(ssc_roll, ssc_board, ssc_year,ssc_reg);	
				return SUCCESS;
		}
		else if (!appScode.equals(scode)|| !appContactno.equals(contactno))
		{
			Gson gson = new Gson();
			String json="";
			json = gson.toJson("<div class='msg_div' style='font-size: 24px; text-align: center; color: #EC0F18; background-color: #FDD0D0;	padding: 12px; border: 2px solid #FFCFD0;	border-radius: 5px;	box-shadow: 0px 0px 8px #888888;'>Mobile number or security code is not valid<br/> &#2478;&#2507;&#2476;&#2494;&#2439;&#2482; &#2472;&#2478;&#2509;&#2476;&#2480; &#2476;&#2494; security code &#2488;&#2464;&#2495;&#2453; &#2472;&#2479;&#2492;</div>");
			 
			//json = gson.toJson("<div class='msg_div' style='height: 150px;color: blue;'><center> <font size='4' color='red'>Mobile number or security code is not valid</font></center></div>");
			setJsonResponse(json);
			return null;
		}
	...
	public String PersonalInfoSMSOnly()
	{
		String is_active=(String)session.get("is_active");
		if(!is_active.equals("1"))
		{
	...
	private boolean isValidMobile(String mobileNumber)
	{
		...
		if(mobileNumber.length()!=11)
			tmp=false;
		if(!(mobileNumber.substring(0,3).equalsIgnoreCase("013") ||mobileNumber.substring(0,3).equalsIgnoreCase("014")
	...
	public String getApplicantForCancel()
	{
		...
		else
		{
			try{
		    	 response.setContentType("text/html");
		    	 response.getWriter().write("<input type=\"hidden\" id=\"application_id\" value=\""+applicant.getApplication_id()+"\">");
		    	 response.getWriter().write("<input type=\"hidden\" id=\"merit_type\" value=\""+applicant.getMerit_type()+"\">");
		    	 response.getWriter().write("<table width=\"600px\">");
		    	 response.getWriter().write("<tr><td>Application Id</td><td>Student Name</td><td>EIIN</td><td>Merit</td>");
		    	 response.getWriter().write("<tr><td>"+applicant.getApplication_id()+"</td><td>"+applicant.getStudent_name()+
		    			 "</td><td>"+applicant.getEiin()+"</td><td>"+applicant.getMerit()+"</td>");
		    	 response.getWriter().write("</table>");
		    	 response.getWriter().write("<br/><input type=\"button\" onclick=\"cadmission()\" value=\"Cancel Admission\">");
			}
			catch(Exception e) {e.printStackTrace();}
			return null;			
		}
...
//		System.out.println(merit_type);
	...
	public String getThanas(){
		HashMap<String, ArrayList<ThanaDTO>> ThanaMap=(HashMap<String, ArrayList<ThanaDTO>>)ServletActionContext.getServletContext().getAttribute("THANA_LIST");
	...
	public String getColleges(){
		HashMap<String, ArrayList<CollegeDTO>> collegeMap=(HashMap<String, ArrayList<CollegeDTO>>)ServletActionContext.getServletContext().getAttribute("ALL_COLLEGE_MAP");
		HashMap<String, ArrayList<CollegeDTO>> collegeMapDist=(HashMap<String, ArrayList<CollegeDTO>>)ServletActionContext.getServletContext().getAttribute("ALL_COLLEGE_MAP_DIST");
...
//        }
		...
		if(college_search_type.equalsIgnoreCase("by_thana")){
			ArrayList<CollegeDTO> collegeList=collegeMap.get(thana_id+helper_board_id);
			gson = new Gson();
			json = gson.toJson(collegeList);
			json="{\"colleges\":"+json+",\"thana_id\" :\""+thana_id+"\",\"helper_board_id\":\""+helper_board_id+"\"}";
		}
		if(college_search_type.equalsIgnoreCase("by_district")){
			ArrayList<CollegeDTO> collegeList=collegeMapDist.get(district_id+helper_board_id);
			gson = new Gson();
			json = gson.toJson(collegeList);
			json="{\"colleges\":"+json+",\"district_id\" :\""+district_id+"\",\"helper_board_id\":\""+helper_board_id+"\"}";
		}
	...
	/**
	 * @author nasir
	 * @param boardId and distId
	 * @return district list with eiin in json format to show on html view of svg
	 */
	public String getCollegesForPdf(){		
		Gson gson;
		String json = null;
		ApplicationStatBoardDAO collegeinfoDAO = new ApplicationStatBoardDAO();
		List<CollegeInfoDTO> collegeinfoList = collegeinfoDAO.getCollegeByDistrict(helper_board_id,district_id);
		gson = new Gson();
...
//		System.out.println(" Session Activity " + session.get("ssc_roll"));
		...
		String totalSeat1="\"total_seat1\":"+svg.getSvgTotalSeat1().toString().replaceAll("=", ":");
		totalSeat1=totalSeat1.replaceAll("\\[", "\"");
		totalSeat1=totalSeat1.replaceAll("\\]", "\"");
		totalSeat1=totalSeat1.replaceAll(":\\{", ":\\{\"");
		totalSeat1=totalSeat1.replaceAll(":\"", "\":\"");
		totalSeat1=totalSeat1.replaceAll("\", ", "\", \"");
		...
		String svgString="{"+shift+","+version+","+group+","+sqYN+","+totalSeat+","+availableSeat+","+eligibility+","+totalSeat1+"}";
...
//		String captcha_value=(String)request.getSession().getAttribute("servlet_captcha");
...
//		}
		...
		System.out.println("Application Submission Status :<<"+response.getStatus()+">> || <<"+response.getApplication_id()+">>");
	...
	public String submitApplication_TT(){
		...
		System.out.println(df.format(new Date())+ " SubmitApplication Start : roll-"+applicant.getSsc_info().getRoll()+" board-"+applicant.getSsc_info().getBoard_id()+" year-"+applicant.getSsc_info().getPassing_year() );		

		ResponseDTO response=new ResponseDTO();
		Gson gson = new Gson();
		String strNID = applicant.getApplication_info().getNid_number();
		try{
			if(strNID!=null && !strNID.equalsIgnoreCase("")) {
				if(!strNID.matches("[0-9]+")){
				    System.out.println("NID is not valid");
				    response.setStatus("INVALID");
					response.setMessage("NID is not valid.!!!");
		...
		try{
			...
			String strDate = "01-01-1997";
			java.util.Date date1 = format.parse(applicant.getSsc_info().getBirth_date());
		...
		*/
		...
		try
		{
			if(!(session.get("ssc_roll").equals(applicant.getSsc_info().getRoll()) && session.get("ssc_board").equals(applicant.getSsc_info().getBoard_id()) && 
					session.get("ssc_year").equals(applicant.getSsc_info().getPassing_year()) && session.get("ssc_reg").equals(applicant.getSsc_info().getReg_no())
					&& session.get("gpa").equals(applicant.getSsc_info().getGpa()) && session.get("eiin").equals(applicant.getSsc_info().getEiin())
					 && session.get("group_id").equals(applicant.getSsc_info().getGroup_id())))
			{
				System.out.println("Sorry, you have manipulated your SSC basic information. We can't accept your application.!!!");
				response.setStatus("INVALID");
...
//		for (int i = 0; i < choice.size(); i++)
		...
		{  
			System.out.println("Sorry, We can't accept your application.!!!");
			response.setStatus("ERROR");
			response.setMessage("Sorry, We can't accept your application.!!!");
			String json = gson.toJson(response);setJsonResponse(json);return null;
		}
		uniqueChoiceSet = new HashSet<String>();
		for(int i=0;i<choice.size();i++){
			ChoiceDTO tmpchoice = choice.get(i);
			uniqueChoiceSet.add(tmpchoice.getPriority());
		}
		if(uniqueChoiceSet.size()!=choice.size())
		{  
			System.out.println("Sorry, We can't accept your application.!!!");
		...
		// checking UNIQUE EIIN set
		uniqueChoiceSet = new HashSet<String>();
		for(int i=0;i<choice.size();i++){
			uniqueChoiceSet.add(choice.get(i).getEiin());
		}
		/*if(choiceEiinSet.size() < 5){
			System.out.println("Application failed. You need to select at least 5 (five) different colleges.");
			response.setMessage("Application failed. You need to select at least 5 (five) different colleges.");
			response.setStatus("INVALID");
			String json = gson.toJson(response);setJsonResponse(json);return null;
		}*/
		if(uniqueChoiceSet.size() < 5){
			System.out.println("Application failed. You need to select at least 5 (five) different colleges.");
			response.setMessage("Application failed. You need to select at least 5 (five) different colleges.");
			response.setStatus("INVALID");
			String json = gson.toJson(response);setJsonResponse(json);return null;
		...
		if(uniqueChoiceSet.size()>10){
			System.out.println("Application failed. You can not select more than 10 (ten) different colleges.");
		...
		if(applicant.getApplication_info().getQuota_ff()==null)applicant.getApplication_info().setQuota_ff("N");
		if(applicant.getApplication_info().getQuota_eq()==null)applicant.getApplication_info().setQuota_eq("N");
		if(applicant.getApplication_info().getQuota_bksp()==null)applicant.getApplication_info().setQuota_bksp("N");
		if(applicant.getApplication_info().getQuota_expatriate()==null)applicant.getApplication_info().setQuota_expatriate("N");
		
		ApplicationDAO applicationDAO=new ApplicationDAO();
		System.out.println(df.format(new Date())+ " SubmitApplication Before Validation : roll-"+applicant.getSsc_info().getRoll()+" board-"+applicant.getSsc_info().getBoard_id()+" year-"+applicant.getSsc_info().getPassing_year() );
		response=applicationDAO.validateApplication_TT(applicant, choice,"NEW");
		System.out.println(df.format(new Date())+ " SubmitApplication After Validation : roll-"+applicant.getSsc_info().getRoll()+" board-"+applicant.getSsc_info().getBoard_id()+" year-"+applicant.getSsc_info().getPassing_year() );
		String scode = getSecurityCode();
		if(response.getStatus().equalsIgnoreCase("VALID"))
		{						
			System.out.println(df.format(new Date())+ " SubmitApplication Before Procedure : roll-"+applicant.getSsc_info().getRoll()+" board-"+applicant.getSsc_info().getBoard_id()+" year-"+applicant.getSsc_info().getPassing_year() );
			response=applicationDAO.saveApplication_TT(applicant, choice, getIpAddressDTO(),scode);
			System.out.println(df.format(new Date())+ " SubmitApplication After Procedure : roll-"+applicant.getSsc_info().getRoll()+" board-"+applicant.getSsc_info().getBoard_id()+" year-"+applicant.getSsc_info().getPassing_year() );
...
//				response.setScode(scode);
			...
			{
				System.out.println("New Submission Status :<<"+response.getStatus()+">> || << message:"+response.getMessage()+">>");
				if(response.getMessage().contains("APPLICANT_INFO_UQ1"))
				{
					response.setMessage("National ID already used");
				}
			}
			
		}
		
		System.out.println(df.format(new Date())+ " New Submission Status :<<"+response.getStatus()+">> || << ID:"+response.getApplication_id()+">>");
		System.out.println(df.format(new Date())+ " SubmitApplication End : roll-"+applicant.getSsc_info().getRoll()+" board-"+applicant.getSsc_info().getBoard_id()+" year-"+applicant.getSsc_info().getPassing_year() );
		ResponseDTO response1 = new ResponseDTO();
		response1.getApplication_info().setQuota_ff(response.getApplication_info().getQuota_ff());
		response1.getSscInfo().setRoll(response.getSscInfo().getRoll());
		response1.getSscInfo().setPassing_year(response.getSscInfo().getPassing_year());
		response1.getSscInfo().setBoard_name(response.getSscInfo().getBoard_name());
		response1.getSscInfo().setStudent_name(response.getSscInfo().getStudent_name());
		response1.setPassword("");
		response1.setApplication_id("");
	...
	public String submitApplicationEdit_TT(){
		...
		if(session.get("smsapplication")!=null && !((String)session.get("smsapplication")).equalsIgnoreCase(String.valueOf(choice.size())) )
		{
			response.setMessage("You did manupulation!!!.");
			response.setStatus("INVALID");
			String json = gson.toJson(response);setJsonResponse(json);return null;
		}
...
//			}
		...
		{
			String scode = "";
//			if(session.get("webpayment")!=null && ((String)session.get("webpayment")).equalsIgnoreCase("no"))
//				scode = getSecurityCode();

			String contactno = (String)session.get("contactno");
			if(session.get("smsapplication")==null)
				response=applicationDAO.saveApplicationEdit_TT(applicant, choice, getIpAddressDTO(),scode,contactno);
			else if (((String)session.get("smsapplication")).equalsIgnoreCase(String.valueOf(choice.size())))
				response=applicationDAO.editApplicationSMSOnly(applicant, choice, getIpAddressDTO(),scode,contactno);
			else
			{
				response.setStatus("INVALID");
            	response.setMessage("Not a valid application"); 
			}
			if(response.getMessage().contains("APPLICANT_INFO_UQ1"))
			{
				response.setMessage("National ID already used");
		...
		System.out.println("App Edit Status :<<"+response.getStatus()+">> || <<"+response.getApplication_id()+">>");
		if(!response.getStatus().equalsIgnoreCase("OK"))
		{
			System.out.println("App Edit Status :<<"+response.getStatus()+">> || <<"+response.getMessage()+">>");
		}
		ResponseDTO response1 = new ResponseDTO();
		response1.getApplication_info().setQuota_ff(response.getApplication_info().getQuota_ff());
		response1.getSscInfo().setRoll(response.getSscInfo().getRoll());
	...
	public String editSMSApplication_TT(){
		ResponseDTO response=new ResponseDTO();
		Gson gson = new Gson();
...
//				scode = getSecurityCode();
	...
	public String submitNewApplication(){
		...
		{	response=applicationDAO.saveNewApplication(applicant, choice,getIpAddressDTO());
			System.out.println("Application Submission Status(2nd Phase) :<<"+response.getStatus()+">> || <<"+response.getApplication_id()+">>");
		}
		String json = gson.toJson(response);
		setJsonResponse(json);
        return null;
	...
	public String choiceListReport_TT(){
		String ssc_board = session.get("ssc_board")==null?"":session.get("ssc_board").toString();
		String ssc_year = session.get("ssc_year")==null?"":session.get("ssc_year").toString();
		String ssc_roll = session.get("ssc_roll")==null?"":session.get("ssc_roll").toString();
		application_id=ssc_board+ssc_year+ssc_roll;
		if(application_id!=null
		&& application_id.equalsIgnoreCase(ssc_board+ssc_year+ssc_roll))
		{
			CollegeDAO collegeDAO=new CollegeDAO();
	...
	public String getRegPayment()
	{
		...
		try {
//			tmp = ApplicationDAO.getRegPayment(ssc_roll.trim(), ssc_board.trim(), ssc_year.trim(), ssc_reg.trim());
			tmpResult = ApplicationDAO.getRegPaymentRec(ssc_roll.trim(), ssc_board.trim(), ssc_year.trim(), ssc_reg.trim());
		} catch (Exception e) {
			// TODO: handle exception
		}
...
//		}
		...
		if(tmpResult!=null)
		{
			...
			else if(tmpResult.getPaid().equalsIgnoreCase("YES") && tmpResult.getCollegereceive().equalsIgnoreCase("Not Received"))
			{
				meritTable += "<div class=\"box_container\" style=\"overflow: hidden; position: relative; height: 100%; margin-top: 8px;\" id=\"personal_result_div\"><div class=\"box_header\">Your Result</div><div class=\"box_body\" style=\"padding: 12px;\"><div class=\"successMessageDiv\" id=\"finalResultDiv\">";
				meritTable += "<div  class=\"successResultMessage green\">" +
							"&#2438;&#2474;&#2472;&#2494;&#2480; &#2472;&#2495;&#2486;&#2509;&#2458;&#2494;&#2527;&#2472;&#2503;&#2480; &#2463;&#2494;&#2453;&#2494; &#2460;&#2478;&#2494; &#2489;&#2527;&#2503;&#2459;&#2503;&#2404; &#2477;&#2480;&#2509;&#2468;&#2495;&#2480; &#2460;&#2472;&#2509;&#2479; &#2536;&#2541;/&#2534;&#2540;/&#2536;&#2534;&#2535;&#2543; &#2489;&#2468;&#2503; &#2537;&#2534;/&#2534;&#2540;/&#2536;&#2534;&#2535;&#2543; &#2468;&#2494;&#2480;&#2495;&#2454;&#2503;&#2480; &#2478;&#2471;&#2509;&#2479;&#2503; &#2453;&#2482;&#2503;&#2460;&#2503; &#2479;&#2507;&#2455;&#2494;&#2479;&#2507;&#2455; &#2453;&#2480;&#2468;&#2503; &#2489;&#2476;&#2503;&#2404;	</div>";
				meritTable += "</div></div></div>";
				try {
					response.setContentType("text/html");
					response.getWriter().write(meritTable);
